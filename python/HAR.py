...
# need Actions.txt ( https://github.com/pm1715/HAR_Project/blob/main/Actions.txt )
# need resnet-34_kinetics.onnx ( https://github.com/shuvamdas/human-activity-recognition/blob/master/resnet-34_kinetics.onnx )
